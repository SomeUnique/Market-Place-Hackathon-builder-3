 ...
 const page = () => {
  return (
    <div className='bg-white md:max-w-[1920px]'>
     ...
     <div className='md:max-w-[424px] w-full h-[624px] shadow-sm shadow-[#FF9f0D] border-[1px] space-y-2 md:mx-[40%] mx-8 my-36'>
      ...
      <div className='flex p-4 gap-4 md:mx-8 mx-2 rounded-md border-[1px] '>
        ...
        <button className='md:max-w-[360px] w-full h-[44px] md:mx-8 mx-2 rounded-md bg-[#FF9f0D] text-[#ffffff] p-2 '>Sign Up</button>
        ...
        <div className='w-full  flex items-center justify-center'>
          ...
          <div className='flex p-4 gap-16 md:mx-8 mx-2 rounded-md border-[1px] '>
        <FcGoogle  size={24} />
